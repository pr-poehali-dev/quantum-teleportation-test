...
const services = [
  {
    name: "Микрозаймы",
    description: "Финансирование для старта и развития бизнеса.",
    features: [
      "Сумма до 5 000 000 ₽",
      "Ставка от 1% в год",
      "Срок до 3 лет",
  ...
  {
    name: "Консультации",
    description: "Экспертная помощь по всем вопросам ведения бизнеса.",
    badge: "Бесплатно",
    features: [
  ...
  },
  {
    ...
    description: "Офисные помещения и инфраструктура для вашего бизнеса.",
    features: [
      "Льготная аренда офиса",
      "Переговорные комнаты",
      "IT-центр (с 2024 года)",
